      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 relative z-10">
        <div className="flex items-center gap-12">
          ...
          <div className="flex-1 flex justify-center">
            <div className="w-80 h-96 bg-white rounded-3xl p-4 shadow-2xl">
              <div className="w-full h-full bg-gray-100 rounded-2xl flex items-center justify-center">
                <div className="text-center">
                  <div className="text-gray-400 text-lg mb-4">Mobile App Interface</div>
                  <div className="text-gray-500 text-sm">
                    <div className="mb-2">• Burger</div>
                    <div className="mb-2">• Pizza</div>
                    <div className="mb-2">• Coffee</div>
                    <div className="mb-2">• Product Listings</div>
                  </div>
                </div>
              </div>
            </div>
