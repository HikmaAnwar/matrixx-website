    ...
    <footer className="relative bg-[#464646] text-white">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex space-x-2">
              <a href="#" className="w-6 h-6 border border-[#00ABB1] rounded flex items-center justify-center hover:bg-[#00ABB1] transition-colors">
                <svg className="w-3 h-3 text-[#00ABB1]" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="space-y-2 text-left">
            ...
            <ul className="space-y-1 pl-20 mt-2">
              ...
              <li><a href="#" className="text-white hover:text-[#00ABB1] transition-colors text-sm">SaSS Product</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-2 text-left">
            ...
            <ul className="space-y-1 pl-20 mt-2">
              ...
              <li><a href="#" className="text-white hover:text-[#00ABB1] transition-colors text-sm">EVD APP</a></li>
            </ul>
          </div>
      ...
      <div className="absolute bottom-0 right-0 opacity-20">
        <div className="relative">
          <div className="w-24 h-24 bg-[#00ABB1] rounded-full opacity-20 absolute -bottom-6 -right-6"></div>
          <div className="w-16 h-16 bg-[#00ABB1] rounded-full opacity-30 absolute -bottom-3 -right-3"></div>
          <div className="w-8 h-8 bg-[#00ABB1] rounded-full opacity-40 absolute -bottom-1 -right-1"></div>
        </div>
      </div>
      ...
      <div className="bg-[#F3F3F3] text-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center pt-0.5 pb-0">
          ...
          <div className="flex space-x-4 mt-0 md:mt-0">
            <a href="#" className="text-[#00ABB1] hover:text-[#0B3A93] transition-colors text-xs font-bold">Privacy</a>
            <a href="#" className="text-[#00ABB1] hover:text-[#0B3A93] transition-colors text-xs font-bold">Terms and Conditions</a>
          </div>
        </div>
      </div>
    </footer>
